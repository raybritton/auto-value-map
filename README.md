...
```groovy
ext.autoMapVersion = '2.3.0'

annotationProcessor "com.raybritton.autovaluemap:auto-value-map:$autoValueVersion"
provided "com.raybritton.autovaluemap:auto-value-map:$autoValueVersion"
